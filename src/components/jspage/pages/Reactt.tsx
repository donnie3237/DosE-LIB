  ...
  return (
    <div className="jsmain">
        ...
        <div className="jscontents">
            ...
            <h3>ReactJS with TypeScript</h3>
            <p>การใช้TypeScript เป็นอีกทางที่ดีที่จะช่วยให้คุณ ไเ้ชิ้นงานที่มีประสิทธิภาพ และตรวจดีบักได้เยอะ แถมได้โค้ดที่มีระเบียบอีกด้วย หากคุณต้องการใช้สำหรับ TypeScript ให้ใช้คำสั่งตามนี้</p>
            <div className="therminal">
            ...
            <h3>Redux</h3>
            <p>Redux เป็นตัวช่วยที่ดีในการเก็บค่าState และการจัดการที่เป็นระเบียบและเรียบง่ายมากขั้น สำหรับโรเจคใหญ่ขึ้นมา มันเป็นอีก lib ที่สำคัญมากจริงๆ ติดตั้งได้โดย</p>
            <div className="therminal">
              <p>npm i redux</p>
              <div className="comment">
                //สำหรับติดตั้ง Redux แบบคูลๆ
              </div>
            </div>
            <h3>More</h3>
