    ...
    <div className="contain"  >
      ...
      <div className="cropeiei"> 
        ...
        <div className="sec sec5" >
            ...
            <p>ด้านไฟฟ้าในปัจจุบันเทคโนโลยีด้านไฟฟ้า อิเล็กทรอนิกส์ และคอมพิวเตอร์ มีบทบาทต่อการใช้ชีวิตของมนุษย์อย่างมหาศาล รวมถึงฝั่งโรงงานอุตสาหกรรม โดยอุปกรณ์ มักจะมีขนาดเล็ก ต้องการพลังน้อย แต่มีสมรรถภาพสูง และมีความฉลาด การเขียนโปรแกรมจึงมีส่วนช่วยในเรื่องนี้ เช่น ระบบเปิดปิดไฟผ่านแอพพลิเคชั่นที่รวมความรู้ด้าน(การต่อวงจรไฟฟ้า,IOT,WebAppServer เข้าด้วยกัน</p>
            <p>ด้านพลังงาน มีหลายโปรเจคที่นำความรู้ด้านการเขียนโปรแกรมมาช่วย เช่น ระบบล้างแผงโซล่าร์เซลล์อัตโนมัติ(MIT),การช่วยวิจัยตัวแปรต่างๆต่อการผลิดพลังงานเพื่อปรับปรุงประสิทธิภาพ(BigData,DataScient),ระบบคำนวณพลังงานที่ผลิดได้ในแต่ละวันรวมถึงระบบจัดการพลังงานที่มีอยู่(TeslaPowerWallApp)</p>
